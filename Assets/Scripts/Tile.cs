...
public class Tile : MonoBehaviour
{
        ...
        if(pieceSprite != null){
            if(manager.turnWhite && white || !manager.turnWhite && !white){
                if(!anim){
                    ...
                    center.enabled = true;
                    piecePosition.position = new Vector2(manager.tiles[piece.y,piece.x].gameObject.transform.position.x, manager.tiles[piece.y,piece.x].gameObject.transform.position.y + manager.difY);
    ...
    void MovePiece(Tile pos, Tile pre){
        ...
        pos.piecePosition.position = new Vector2(manager.tiles[pos.piece.y,pos.piece.x].gameObject.transform.position.x, manager.tiles[pos.piece.y,pos.piece.x].gameObject.transform.position.y + manager.difY);
    }
