...
public class Manager : MonoBehaviour
{
    ...
    void Organize(Piece piece)
    {
        ...
        int x = piece.x;
        int y = piece.y;
        piece.obj.transform.position = new Vector2(tiles[y,x].gameObject.transform.position.x, tiles[y,x].gameObject.transform.position.y + difY);
